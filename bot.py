...
expected_text = """
Crane lashed against the windows, a rhythmic counterpoint to the crackling fire in the hearth. Curled up with a well-worn book, I savored the cozy atmosphere. The scent of cinnamon and cloves, wafting from the kitchen where a pie baked, filled the air with warmth. Outside, the storm raged, but inside, all was peace and comfort.
"""
